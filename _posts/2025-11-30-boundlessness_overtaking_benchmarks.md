...
tags: long-form-research-reports science AI-Scientist evaluation
...
bibliography: 2025-11-30-boundlessness-overtaking-benchmarks.bib
...
toc:
  - name: Introduction
  - name: The Evaluation Problem No One Wants to Name
  - name: Progress Lacks Standard Measurement
  - name: Conclusion
  - name: Now And Next
  - name: References
...
**Assumption 1**: There exists a canonical correct answer. <br>
...
**Assumption 2**: Evaluation is output-based. <br>
...
**Assumption 3**: Humans can serve as gold-standard evaluators. <br>
...
**Assumption 4**: Correctness is equivalent to alignment with ground truth. <br>
...
- Domain-expert evaluation: The four novel discoveries were checked by domain expert collaborators, who verified that the reasoning, code, and citations made sense, but didn’t fully reproduce the results with their own experiments. Therefore, the KOSMOS discoveries can be seen as interesting, potentially valuable ideas that passed initial expert screening. <br>
